...
public class BigPlanetTemplate implements EntityTemplate {
	...
	public BigPlanetTemplate() {
		sheetTexture = new Texture(
				Gdx.files.internal("data/Textures/Scenery/BigPlanets.png"));
		framesRegion = new TextureRegion(sheetTexture, FRAMES_WIDTH,
				FRAMES_HEIGHT);
	}
	...
	public Entity buildEntity(Entity e, EntityWorld world, Object... args) {
		...
		Animation sprite = new Animation(sheetTexture, framesRegion,
				SHEET_COLUMNS, SHEET_ROWS, 1f) {
			@Override
		...
		e.addComponent(t);
		e.addComponent(new Parallax(world.getCamera(), 1 / 64f));
